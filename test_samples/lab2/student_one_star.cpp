...
ArrayStack::ArrayStack() : data(new int[64]), capacity(64), count(0) {}
...
ArrayQueue::ArrayQueue() : data(new int[64]), capacity(64), head(0), tail(0), count(0) {}
...
ArrayDeque::ArrayDeque() : data(new int[64]), capacity(64), head(0), tail(0), count(0) {}
